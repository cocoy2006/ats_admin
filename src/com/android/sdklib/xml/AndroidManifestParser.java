                    ...
                    switch (mValidLevel) {
                        case LEVEL_TOP:
                            if (AndroidManifest.NODE_MANIFEST.equals(localName)) {
                                ...
                                // and the versionName
                                mManifestData.mVersionName = getAttributeValue(attributes,
                                		AndroidManifest.ATTRIBUTE_VERSIONNAME, true);
                                mValidLevel++;
                            }
                            break;
                        case LEVEL_INSIDE_MANIFEST:
                            if (AndroidManifest.NODE_APPLICATION.equals(localName)) {
                            	// lets get the application icon first.
                            	mManifestData.mIcon = getAttributeValue(attributes,
                                        AndroidManifest.ATTRIBUTE_ICON,
                                        true /* hasNamespace */);
