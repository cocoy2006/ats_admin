...
public class CsDispatcherDao extends BaseDao<CsDispatcher> {
	...
	public List<CsDispatcher> findByProperty(String propertyName, Object value) {
	...
	public List<CsDispatcher> findByApplicationId(Object applicationId) {
	...
	public List<CsDispatcher> findAll() {
