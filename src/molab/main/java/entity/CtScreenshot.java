...
/**
 * CtScreenshot entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "CT_SCREENSHOT", catalog = "MOLAB")
public class CtScreenshot implements java.io.Serializable {
	...
	public CtScreenshot(String activityName) {
