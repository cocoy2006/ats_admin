				...
				<div class="col-xs-12">
					...
					<div class="btn-toolbar">
	                	<div class="btn-group">
	                  		...
	                  		<!-- <a class="btn btn-default" href="javascript:void(0);" onclick="openModal()">
		                  		<span class="fui-new"></span>&nbsp;编辑设备</a> -->
					  	...
					  	<table class="table table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td>${device.model.manufacturer.name}/${device.model.name}</td>
									<td>${device.sn}</td>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="deviceForm" class="form-horizontal" name="deviceForm">
							...
							<div class="form-group">
								<label class="col-sm-3 control-label" for="imei">
									设备IMEI号
								</label>
								<div class="col-sm-9">
